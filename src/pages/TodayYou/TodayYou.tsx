...
const TodayYou = () => {
    return <div className={styles.body}>
        <SEO title="Today you, tommorow me." />
        <div className={styles.flex}>
            <div className={styles.card}>
                <div className={styles.header}>
                    <div className={styles.title}>
                        <div>
                            <h1>Today you, tommorow me.</h1>
                            <h6><span>by</span> Rhoner</h6>
                        </div>
                    </div>
                </div>
                <div className={styles.content}>
                    ...
                    <p>"Today you.... tomorrow me."</p>
                    <a href="https://www.reddit.com/r/AskReddit/comments/elal2/have_you_ever_picked_up_a_hitchhiker/c18z0z2/" className={styles.bttn}>Read the original comment on Reddit</a>
                </div>
            </div>
        </div>
