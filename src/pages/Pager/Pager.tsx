...
const Pager = () => {
  ...
  const [props, set] = useSprings(pages.length, i => ({ x: i * window.innerWidth, sc: 1, display: 'block' as 'block' }));
  const bind = useDrag(({ down, movement: [xMovement], direction: [xDir], distance, cancel }) => {
...
const Pager2 = () => <ClientOnly><Pager/></ClientOnly>
