  ...
  <div className={styles.starwars}>
    ...
    >
      <div style={{ marginTop: '-290px' }}>
        <object width="420" height="315">
          <param name="movie" value="https://www.youtube.com/v/EjMNNpIksaI?version=3&amp;hl=en_US&autoplay=1&amp;autohide=2" />
          <param name="allowFullScreen" value="true" />
          <param name="allowscriptaccess" value="always" />
          <embed src="https://www.youtube.com/v/EjMNNpIksaI?version=3&amp;hl=en_US&autoplay=1&amp;autohide=2" type="application/x-shockwave-flash" width="420" height="315" />
        </object>
      </div>
    </div>
    ...
    <div className={styles.titles}>
      <div className={styles.titlecontent}>
        ...
        <iframe title="iframe" style={{ visibility: 'hidden' }} width="560" height="315" src="https://www.youtube.com/embed/1KAOq7XX2OY" frameBorder="0" allowFullScreen />
      </div>
    </div>
  </div>
);
